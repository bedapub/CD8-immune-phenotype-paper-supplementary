---
title: "Train model on full train data"
...
Learner
```{r learner}
learner <- function() lrn("classif.cv_glmnet", alpha = 1, predict_type = "prob")
```

```{r "train models", include = FALSE, warning = FALSE, message = FALSE}
models <- map(
  tasks,
  ~ learner()$train(.x)
)
